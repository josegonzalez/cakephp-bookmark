...
Bookmark loves to welcome your contributions. There are several ways to help out:
...
* Contribute to the [documentation](https://github.com/josegonzalez/cakephp-bookmark/tree/gh-pages)
...
Bookmark tests requires [PHPUnit](http://www.phpunit.de/manual/current/en/installation.html)
3.5 or higher. To run the testcases locally use the following command:

		./lib/Cake/Console/cake test Bookmark AllBookmark

To run the sniffs for CakePHP coding standards

		phpcs -p --extensions=php --standard=CakePHP ./app/Plugin/Bookmark
...
* [Bug tracker](https://github.com/josegonzalez/cakephp-bookmark/issues)
